...
CUDA_VISIBLE_DEVICES=0,1 ACCELERATE_LOG_LEVEL=info accelerate launch --main_process_port 29502 --config_file configs/ds_config.yaml train.py configs/llama3/task1.yaml
CUDA_VISIBLE_DEVICES=0,1 ACCELERATE_LOG_LEVEL=info accelerate launch --main_process_port 29502 --config_file configs/train_config.yaml train.py configs/llama31/task1.yaml
