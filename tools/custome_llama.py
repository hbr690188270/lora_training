...
class BaseModelOutputWithPast(ModelOutput):
    ...
    per_layer_attention_outputs: Optional[Tuple[torch.FloatTensor, ...]] = None
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        for decoder_layer in self.layers:
            ...
            attention_outputs = layer_outputs[-1]
            per_layer_attention_outputs += (attention_outputs,)
        ...
        return BaseModelOutputWithPast(
            ...
            per_layer_attention_outputs=per_layer_attention_outputs,
        )
